...
class SRDataset(Dataset):
    ...
    def __init__(self, url ,split, crop_size, scaling_factor, lr_img_type, hr_img_type, test_data_name=None):
        """
        ...
        if self.split == 'train':
           self.images = glob.glob('/content/test11.jpg')
        else:
          
            self.images = glob.glob(url)
    ...
    def __getitem__(self, i):
        ...
        """
        # Read image
        img = Image.open(self.images[i%100], mode='r')
